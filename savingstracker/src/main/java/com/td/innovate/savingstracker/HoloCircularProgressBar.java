...
public class HoloCircularProgressBar extends View {
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        // ADDED TO INITIAL LIBRARY: We added this arc so that we get the effect of three colors
        // inside the same circular progress bar. The third color is used from the start to the marker position.
        canvas.drawArc(mCircleBounds, 270, mOverrdraw ? 360 : getMarkerRotation(), false,
                mMarkerColorPaint);
...
//        mIsMarkerEnabled = true;
    ...
    private void updateMarkerColor() {
        ...
        mMarkerColorPaint.setColor(mMarkerColor);
