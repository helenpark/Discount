...
package com.td.innovate.tdiscount.widgets;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setTextColor(Color.parseColor("#7D9487"));
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                TextView vText = (TextView) mTabStrip.getChildAt(i);
                if (position == i) {
                    vText.setTextColor(Color.WHITE);
                } else {
                    vText.setTextColor(Color.parseColor("#7D9487"));
                }
            }
