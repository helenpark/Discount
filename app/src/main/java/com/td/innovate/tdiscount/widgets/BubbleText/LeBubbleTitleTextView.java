package com.td.innovate.tdiscount.widgets.BubbleText;
...
public class LeBubbleTitleTextView extends LeBubbleView implements Runnable {
    ...
    private void initContentTextView(int textColor, String content) {
        ...
        RelativeLayout.LayoutParams contentTvParams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
    ...
    private void initTitleTextView(int textColor) {
        ...
        RelativeLayout.LayoutParams titleTvParams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
    ...
    private void initCancelView(int conRlw) {
        ...
        RelativeLayout.LayoutParams cancelParams = new RelativeLayout.LayoutParams(dip2px(13), dip2px(13));
    ...
    public void setCancelImageOnClickListener(View.OnClickListener l) {
